...
import { DESKTOP_FORK_IDENTITY } from "../../../../scripts/lib/fork-desktop-identity.ts";
...
export function resolveDesktopAppBranding(input: {
  ...
  return {
    baseName: DESKTOP_FORK_IDENTITY.baseName,
    stageLabel,
    displayName: `${DESKTOP_FORK_IDENTITY.baseName} (${stageLabel})`,
  };
}
...
const make = Effect.fn("desktop.environment.make")(function* (
  ...
  const baseDir = resolveDesktopBaseDir({
    ...
    defaultBaseDirName: DESKTOP_FORK_IDENTITY.baseDirName,
  });
  ...
  const userDataDirName = isDevelopment
    ? DESKTOP_FORK_IDENTITY.developmentUserDataDirName
    : DESKTOP_FORK_IDENTITY.packagedUserDataDirName;
  ...
  return DesktopEnvironment.of({
    ...
    appUserModelId: Option.getOrElse(config.appUserModelIdOverride, () =>
      isDevelopment ? DESKTOP_FORK_IDENTITY.developmentAppId : DESKTOP_FORK_IDENTITY.appId,
    ),
    linuxDesktopEntryName: resolveLinuxDesktopEntryName(isDevelopment),
    linuxWmClass: isDevelopment
      ? DESKTOP_FORK_IDENTITY.developmentLinuxWmClass
      : DESKTOP_FORK_IDENTITY.packagedLinuxWmClass,
